...
def main():
    ...
    for i in range(3) :
        ...
        sub_image_depth_1 = message_filters.Subscriber("/device_0/sensor_0/Depth_0/image/data_" + str(i+1), Image)
        sub_image_color_1 = message_filters.Subscriber("/device_0/sensor_1/Color_0/image/data_" + str(i+1), Image)
